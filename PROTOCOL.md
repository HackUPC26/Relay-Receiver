...
**`label`** is one of the 9 valid labels (Section 5.3). **`raw_identifier`** is the normalized Apple identifier; carried end-to-end even though today's receiver UI doesn't surface it.
